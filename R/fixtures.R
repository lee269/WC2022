...
# Create match data template from fixtures
...
matchdata_wide <- matchdata %>% 
  # mutate(goals = round(runif(128, min = 0, max = 4), digits = 0)) %>%
...
groups <- c("Group A", "Group B", "Group C", "Group D", "Group E", "Group F", "Group G", "Group H")
